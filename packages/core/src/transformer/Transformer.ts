import type { IJson, ITransformerConstructor } from '.'
...
export class Transformer {
   ...
   * @param fields 属性列表
   */
  expose<T extends Transformer = this>(...fields: Array<Exclude<OmniTypes.NonMethodKeys<T>, keyof Transformer>>): T
  expose<T extends Transformer = this>(...fields: Array<string>): T
  expose(...fields: any[]): this {
   ...
   * @param fields 属性列表
   */
  exclude<T extends Transformer = this>(...fields: Array<Exclude<OmniTypes.NonMethodKeys<T>, keyof Transformer>>): T
  exclude<T extends Transformer = this>(...fields: Array<string>): T
  exclude(...fields: any[]): this {
    const fieldList = Object.keys(this)
    for (const field of fieldList) {
      if (fields.includes(field)) {
        // ;(this as IJson)[field] = undefined
